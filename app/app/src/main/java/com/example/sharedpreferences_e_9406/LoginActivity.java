package com.example.sharedpreferences_e_9406;
...
import com.example.sharedpreferences_e_9406.Preferences.UserPreferences;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validateForm()){
                    if (etUsername.getText().toString().trim().equals("170709406")
                    && etPassword.getText().toString().trim().equals("rio")){
